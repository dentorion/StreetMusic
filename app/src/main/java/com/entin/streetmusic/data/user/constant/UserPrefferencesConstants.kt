package com.entin.streetmusic.data.user.constant

const val USER_SHARED_PREFERENCES_TAG = "User"
...
const val USER_URL_AVATAR: String = "artist_url_avatar"

/**
 * SharedPreferences MapObserve screen
 */
const val ON_LINE_CONCERTS_LIST = "map"
